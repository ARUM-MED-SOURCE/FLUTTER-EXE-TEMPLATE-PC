...
final prescriptionConsentProvider = StateNotifierProvider<
    PrescriptionConsentStateNotifier,
    ConsentListBase>((ref) {
  final repository = ref.watch(prescriptionConsentRepositoryProvider);
  return PrescriptionConsentStateNotifier(
    ref: ref,
...
class PrescriptionConsentStateNotifier
    extends ConsentListProvider<PrescriptionConsentData, PrescriptionConsentRepository> {
  final Ref ref;
  ...
  Future<void> getData() async {
    try {
      ...
      // if (userId == null || userId == '') return;
        ...
        await getList(
        methodName: ApiMethod.prescriptionConsent,
        userId: "1",
        userPassword: "1",
      ...
      logger.e('Error fetching prescription consent data', error: e, stackTrace: stackTrace);
      state = ConsentListError(
        message: 'Error fetching prescription consent data: ${e.toString()}',
      );
    }
  }
} 