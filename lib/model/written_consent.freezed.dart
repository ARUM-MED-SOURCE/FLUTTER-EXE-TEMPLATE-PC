...
abstract class $WrittenConsentDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({String type, String date, String name, String id});
}
...
class _$WrittenConsentDataImpl implements _WrittenConsentData {
  const _$WrittenConsentDataImpl(
      {this.type = '', this.date = '', this.name = '', this.id = ''});
  ...
  @override
  String toString() {
    return 'WrittenConsentData(type: $type, date: $date, name: $name, id: $id)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, type, date, name, id);
...
abstract class _WrittenConsentData implements WrittenConsentData {
  const factory _WrittenConsentData(
      ...
      final String date,
      final String name,
      final String id}) = _$WrittenConsentDataImpl;
